...
export default function Navbar() {
  ...
  const [notifications] = useState([
    ...
    {
      id: 2,
      text: "You completed your morning meditation goal!",
      time: "1h ago",
    },
    {
      id: 3,
      text: "Your current streak: 7 days! Keep it up 💪",
      time: "Today",
    },
  ]);
                ...
                <div className="relative" ref={notificationRef}>
                  ...
                  >
                    ...
                    {notifications.length > 0 && (
                      <span className="absolute -top-1 -right-1 bg-[#38B69A] text-white text-xs rounded-full w-4 h-4 flex items-center justify-center">
                ...
                >
                  {profilePic ? (
                    <img
                      src={profilePic}
                      alt="Profile"
                      className="w-8 h-8 rounded-full object-cover border-2 border-[#38B69A]"
                      onError={(e) => {
