    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p className="mt-6 text-gray-700 max-w-lg">
            Track your wellness journey, set daily goals, and stay motivated
            with real-time progress visualization, community support, and guided
            wellness plans.
          </p>
        ...
        >
          <div className="relative mx-auto max-w-md p-6 rounded-2xl bg-white border border-gray-200 shadow-2xl">
            <h3 className="text-xl font-semibold text-gray-900 flex items-center gap-2">
              <FaHeartbeat style={{ color: accent }} /> Wellness Dashboard
            </h3>
            <p className="text-sm text-gray-600 mt-2">
              Visualize your daily habits, goals, and progress in one place.
            </p>
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="mt-3 opacity-90 max-w-2xl">
            Track, visualize, and celebrate your wellness habits with beautiful
            ...
            {[
              {
                ...
                desc: "Monitor daily movement and set fitness targets.",
              },
              {
                icon: <FaLeaf />,
                title: "Healthy Nutrition",
                desc: "Track your meals and stay on top of nutrition goals.",
              },
              {
                icon: <FaSmileBeam />,
                title: "Mindfulness & Sleep",
                desc: "Get guided meditations and sleep tracking tools.",
              },
            ].map((f, i) => (
              <motion.div
                key={i}
                whileHover={{ y: -6 }}
                className="p-6 rounded-2xl bg-white/20 border border-white/30"
              >
      ...
      <section id="progress" className="py-16 bg-gray-50 text-gray-900">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-4 flex justify-center items-center gap-2">
            <FaChartLine style={{ color: accent }} /> Track Your Progress
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto mb-8">
            Stay on top of your goals with visualized analytics that make
            improvement tangible and fun.
          </p>
          <motion.div
            whileHover={{ scale: 1.05 }}
            className="p-8 bg-white shadow-lg rounded-2xl border border-gray-200 inline-block"
          >
      ...
      <section id="community" className="py-16 bg-white text-gray-900">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h3 className="text-3xl font-bold mb-4 flex justify-center items-center gap-2">
            <FaUsers style={{ color: accent }} /> Join Our Wellness Community
          </h3>
          <p className="text-gray-600 max-w-3xl mx-auto mb-6">
            Connect with others on a similar journey, share your wins, and get
            inspired by people who care about holistic health.
          </p>
          <button
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-6">
              We’re here to help you stay on track with your wellness goals.
              Reach out anytime!
            </p>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-center gap-2">
                <FaHeartbeat style={{ color: accent }} />{" "}
                support@wellnesshabit.com
              </li>
              <li className="flex items-center gap-2">
                <FaHeartbeat style={{ color: accent }} /> +1 (234) 567-890
              </li>
            </ul>
          </div>
          ...
          <form className="bg-gray-50 p-6 rounded-xl border border-gray-200 shadow">
            ...
            <button
              type="submit"
              className="w-full p-3 rounded-full text-white font-semibold"
              style={{ backgroundColor: accent }}
            >
              Send Message
            </button>
      ...
      <footer className="py-8 border-t border-gray-200 text-center text-sm text-gray-600 bg-white/90 backdrop-blur-md">
        ...
        <p className="font-semibold text-gray-800">
          ...
          <span className="text-green-600">Wellness Habit Tracker</span> —
        ...
        <div className="mt-4 flex justify-center gap-4">
          ...
          <a href="#goals" className="hover:text-green-500 transition-colors">
            Goals
          </a>
          <a
            href="#community"
