...
const Profile = () => {
    ...
    try {
      ...
      const updatedUserData = {
        ...
        goal:
          ...
          "Stay consistent with wellness habits",
        profilePicture:
          profileData.user.profilePicture || profileData.avatar || "",
      };
      ...
      setWellnessStats({
        ...
        completedHabits:
          statsData.completedHabits || statsData.habitsCompleted || 0,
        totalGoals: statsData.totalGoals || statsData.goalsTotal || 0,
        completedGoals:
          statsData.completedGoals || statsData.goalsCompleted || 0,
      });
    } catch (err) {
  ...
  const uploadProfilePicture = async (file) => {
    ...
    try {
      ...
      const newProfilePicture =
        data.profilePicture || data.imageUrl || data.avatar;
      setUserData((prev) => ({
        ...prev,
  ...
  const getCompletionPercentage = () => {
    ...
    return Math.round(
      (wellnessStats.completedHabits / wellnessStats.totalHabits) * 100
    );
  };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#f8f4ff] to-[#f0e5ff] flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#38B69A] mx-auto mb-4"></div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          ...
          {!isEditing && (
            <button
              onClick={handleEdit}
              disabled={loading}
              className="flex items-center space-x-2 px-6 py-3 rounded-lg bg-[#38B69A] hover:bg-[#2E8B75] transition-colors font-semibold text-white shadow-lg w-full sm:w-auto justify-center"
            >
              <FaEdit />
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <section className="bg-white p-6 rounded-2xl shadow-lg flex flex-col items-center">
              <div className="relative">
                <div className="w-32 h-32 rounded-full bg-gradient-to-r from-[#38B69A] to-[#2E8B75] flex items-center justify-center font-bold text-4xl text-white shadow-lg mb-4 overflow-hidden">
                ...
                <div className="absolute bottom-2 right-2">
                  <label className="bg-[#38B69A] text-white p-3 rounded-full shadow-lg cursor-pointer hover:bg-[#2E8B75] transition-colors block">
              ...
              {isEditing ? (
                <input
                  ...
                  className="w-full text-center bg-gray-100 rounded-lg px-4 py-2 mt-1 text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#38B69A] text-xl font-bold border border-gray-300"
            ...
            <section className="bg-white p-6 rounded-2xl shadow-lg space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  {isEditing ? (
                    <input
                      ...
                      className="w-full bg-gray-50 rounded-lg px-4 py-3 text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#38B69A] border border-gray-300"
                ...
                <div>
                  <label className="text-sm font-medium text-gray-500 flex items-center space-x-2 mb-2">
                    <FaEnvelope className="text-[#38B69A]" />
              ...
              {isEditing && (
                <div className="flex flex-col sm:flex-row gap-3 mt-6 pt-4 border-t">
                  ...
                  <button
                    onClick={handleSave}
                    disabled={loading}
                    className="flex-1 px-4 py-3 rounded-lg bg-[#38B69A] hover:bg-[#2E8B75] transition-colors font-semibold text-white disabled:opacity-50"
                  >
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <section className="bg-white p-6 rounded-2xl shadow-lg">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div className="bg-gradient-to-br from-[#f8f4ff] to-[#f0e5ff] p-4 rounded-xl text-center border border-[#38B69A]">
                  <FaTrophy className="mx-auto text-[##38B69A] h-6 w-6 mb-2" />
                  <p className="text-xl font-bold text-gray-800">
                    {wellnessStats.totalHabits}
                  </p>
                  <p className="text-xs text-gray-600 mt-1">Total Habits</p>
                </div>
                <div className="bg-gradient-to-br from-[#f8f4ff] to-[#f0e5ff] p-4 rounded-xl text-center border border-[#38B69A]">
                  <FaFire className="mx-auto text-[#38B69A] h-6 w-6 mb-2" />
                  <p className="text-xl font-bold text-gray-800">
                ...
                <div className="bg-gradient-to-br from-[#f8f4ff] to-[#f0e5ff] p-4 rounded-xl text-center border border-[#38B69A]">
                  <FaChartLine className="mx-auto text-[#38B69A] h-6 w-6 mb-2" />
                  <p className="text-xl font-bold text-gray-800">
                    {wellnessStats.longestStreak}
                  </p>
                  <p className="text-xs text-gray-600 mt-1">Longest Streak</p>
                </div>
                <div className="bg-gradient-to-br from-[#f8f4ff] to-[#f0e5ff] p-4 rounded-xl text-center border border-[#38B69A]">
                  <div className="mx-auto text-[#38B69A] h-6 w-6 mb-2 flex items-center justify-center text-lg font-bold">
                    {getCompletionPercentage()}%
                  </div>
                  <p className="text-xl font-bold text-gray-800">
                    {wellnessStats.completedHabits}
                  </p>
                ...
                <div className="bg-gradient-to-br from-[#f8f4ff] to-[#f0e5ff] p-4 rounded-xl text-center border border-[#38B69A]">
                  <FaTrophy className="mx-auto text-[#38B69A] h-6 w-6 mb-2" />
                  <p className="text-xl font-bold text-gray-800">
                    {wellnessStats.totalGoals}
                  </p>
                  <p className="text-xs text-gray-600 mt-1">Total Goals</p>
                </div>
                <div className="bg-gradient-to-br from-[#f8f4ff] to-[#f0e5ff] p-4 rounded-xl text-center border border-[#38B69A]">
                  <div className="mx-auto text-[#38B69A] h-6 w-6 mb-2 flex items-center justify-center">
                    ✅
                  </div>
                  <p className="text-xl font-bold text-gray-800">
                    {wellnessStats.completedGoals}
                  </p>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-3">
                    <div
                      className="bg-[##38B69A] h-3 rounded-full transition-all duration-500"
              ...
              wellnessStats.currentStreak > 0 ? (
                <div className="space-y-3">
                  {wellnessStats.completedHabits > 0 && (
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                      <span className="text-gray-700 font-medium">
                        Completed {wellnessStats.completedHabits} habits today
                      </span>
                  ...
                  {wellnessStats.currentStreak > 0 && (
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                      <span className="text-gray-700 font-medium">
                        Current streak: {wellnessStats.currentStreak} days
                      </span>
                      <span className="px-3 py-1 bg-[#38B69A] text-white rounded-full text-sm font-semibold">
                        Active
                      </span>
                    </div>
                  )}
                  {wellnessStats.completedGoals > 0 && (
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                      <span className="text-gray-700 font-medium">
                        Completed {wellnessStats.completedGoals} goals
                      </span>
                ...
                <div className="text-center py-8 text-gray-500">
                  <p>
                    No recent activity. Start tracking your habits to see
                    progress here!
                  </p>
                </div>
              )}
