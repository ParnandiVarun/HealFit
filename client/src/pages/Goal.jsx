...
function GoalsPage() {
  ...
  const sections = [
    {
      id: "organization",
      icon: <FaHome className="text-[#38B69A]" />,
      title: "Organization",
      habits: [
        {
          title: "Make Your Bed",
          desc: "Start your day tidy by making your bed.",
        },
        {
          title: "Keep Your Home Tidy",
          desc: "Clean and declutter regularly.",
        },
        {
          title: "Organize an Area Each Day",
          desc: "Tackle one small area daily.",
        },
        {
          title: "Limit Social Media",
          desc: "Set time limits to stay productive.",
        },
      ],
    },
    {
      id: "relationships",
      icon: <FaHeart className="text-[#38B69A]" />,
      title: "Relationships",
      habits: [
        {
          title: "Connect with People",
          desc: "Reach out and nurture friendships.",
        },
        {
          title: "Spend Time with Each Child",
          desc: "Create one-on-one moments.",
        },
        {
          title: "Spend Time with Your Partner",
          desc: "Schedule regular quality time.",
        },
        {
          title: "Communicate with Your Partner",
          desc: "Have open, honest talks.",
        },
        {
          title: "Compliment Someone",
          desc: "Brighten someone's day genuinely.",
        },
      ],
    },
    {
      id: "selfcare",
      icon: <FaUser className="text-[#38B69A]" />,
      title: "Self-Care",
      habits: [
        { title: "Meditate", desc: "Take time daily to find calm and focus." },
        {
          title: "Deep Breathing",
          desc: "Use breathing to relax the body and mind.",
        },
        { title: "Yoga", desc: "Improve strength and clarity through yoga." },
        { title: "Skincare", desc: "Follow a daily skincare routine." },
        {
          title: "Relax",
          desc: "Unwind with calming activities or a bubble bath.",
        },
      ],
    },
    {
      id: "personal",
      icon: <FaLeaf className="text-[#38B69A]" />,
      title: "Personal Development",
      habits: [
        { title: "Track Mood", desc: "Monitor your emotions daily." },
        {
          title: "Positive Affirmations",
          desc: "Build confidence through affirmations.",
        },
        { title: "Gratitude Log", desc: "Write 3 things you're grateful for." },
        {
          title: "Journal Every Day",
          desc: "Reflect on your thoughts and growth.",
        },
    ...
    {
      id: "financial",
      icon: <FaDollarSign className="text-[#38B69A]" />,
      title: "Financial",
      habits: [
        { title: "Limit Spending", desc: "Avoid unnecessary purchases." },
        {
          title: "Increase Savings",
          desc: "Set aside a portion of income monthly.",
        },
    ...
    },
    {
      ...
      habits: [
        ...
        {
          title: "Eat 5 a Day",
          desc: "Consume 5 servings of fruits & veggies.",
        },
    ...
    <div className="min-h-screen p-4 md:p-8 text-gray-800 bg-gradient-to-br from-[#f8f4ff] to-[#f0e5ff]">
              ...
              <form onSubmit={addGoal} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-[##38B69A] focus:border-transparent"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="3"
                    className="w-full border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#38B69A] focus:border-transparent resize-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full border border-gray-300 p-3 pl-10 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#38B69A] focus:border-transparent"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex-1 px-4 py-3 bg-[#38B69A] hover:bg-[#2E8B75] text-white rounded-lg transition-colors font-medium flex items-center justify-center gap-2"
                  >
                    {loading ? (
      ...
      <div className="text-center mb-8 md:mb-12">
        <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-4">
          ...
          <span className="text-[#38B69A]">✨</span>
        </h1>
      ...
      <div className="max-w-7xl mx-auto mb-12 md:mb-16">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 flex items-center gap-3">
            ...
            My Goals
            {goals.length > 0 && (
              <span className="bg-[#38B69A] text-white text-sm px-3 py-1 rounded-full">
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-[#38B69A] hover:bg-[#2E8B75] transition-all text-white rounded-xl shadow-lg hover:shadow-xl font-semibold"
          >
            <FaPlus />
            New Goal
          </button>
        ...
        {loading ? (
          <div className="flex justify-center items-center py-12">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#38B69A]"></div>
          </div>
        ) : goals.length > 0 ? (
              ...
              >
                ...
                <div className="space-y-3 mb-4">
                  <div className="flex items-center gap-2 text-sm text-gray-500">
                    <FaCalendarAlt className="text-[#38B69A]" />
                    <span>
                  ...
                  <div className="space-y-1">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium text-[#38B69A]">
                        {goal.progress}%
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        className="bg-[#38B69A] h-2 rounded-full transition-all duration-500"
          ...
          <div className="text-center py-12 bg-white rounded-2xl shadow-lg">
            ...
            <button
              onClick={() => setShowForm(true)}
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#38B69A] hover:bg-[#2E8B75] text-white rounded-lg transition-colors font-semibold"
            >
              <FaPlus />
              ...
              <div className="p-6 border-t">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {section.habits.map((habit, index) => (
                    <div
                      key={index}
                      className="p-4 bg-gradient-to-br from-[#f8f4ff] to-[#f0e5ff] rounded-xl border border-[#38B69A] hover:shadow-md transition-all"
                    >
      ...
      <footer className="text-center mt-12 md:mt-16 text-gray-600 text-sm">
        © 2025 Dream Goals Planner — Designed with{" "}
        <span className="text-[#38B69A]">💚</span> to inspire growth & balance.
      </footer>
    </div>
  );
}
