          ...
          <div className="hidden lg:block relative bg-[##38B69A]">
            ...
            <div className="relative z-10 p-10 flex flex-col h-full justify-center">
              <motion.img
                ...
                style={{ boxShadow: "0 30px 80px rgba(3, 59, 26, 0.18)" }}
              />
                  ...
                  >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="mt-2 block w-full px-4 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#38B69A]"
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="text-sm text-[#195C4B] hover:underline"
                        disabled={loading}
                      >
                        Forgot password?
                      </button>
                    ...
                    <div>
                      <motion.button
                        ...
                        className={`w-full py-3 rounded-xl font-semibold text-white shadow-lg ${
                          loading
                            ? "bg-gray-400 cursor-not-allowed"
                            : "bg-gradient-to-r from-[#38B69A] to-[#2E8B75] hover:from-[#2E8B75] hover:to-[#195C4B]"
                        }`}
                      >
                        {loading ? (
                          <div className="flex items-center justify-center">
