      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white to-[#f7f0ff]">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-2xl text-center max-w-md">
          ...
          <a
            ...
            className="text-[#38B69A] font-medium hover:underline"
          >
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white to-[#f7f0ff]">
      ...
      <div className="relative w-full max-w-5xl mx-6 lg:mx-12">
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 rounded-3xl overflow-hidden shadow-2xl">
          ...
          <div className="hidden lg:block relative bg-[#38B69A]">
            ...
            <div className="relative z-10 p-10 flex flex-col h-full justify-center items-center">
              <motion.div
                ...
                style={{ boxShadow: "0 30px 80px rgba(5, 131, 79, 0.18)" }}
              >
                <motion.div
              ...
              >
                ...
                <p className="text-sm opacity-80 mt-2">Email: {email}</p>
              </motion.div>
              ...
              >
                <div>
                  ...
                  <div className="mt-2 relative">
                    <input
                      ...
                      onChange={change}
                      className="block w-full px-4 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#38B69A]"
                ...
                <div>
                  ...
                  <div className="mt-2 relative">
                    <input
                      ...
                      onChange={change}
                      className="block w-full px-4 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-#2E8B75"
                ...
                <div className="bg-gray-50 p-4 rounded-xl">
                  ...
                  <ul className="text-xs text-gray-600 space-y-1">
                    ...
                    >
                      {/[A-Z]/.test(form.newPassword) ? "✓" : "•"} One uppercase
                      letter
                    </li>
                    <li
                      className={`flex items-center ${
                        /[0-9]/.test(form.newPassword) ? "text-green-600" : ""
                      }`}
                    >
                ...
                <div className="text-center text-sm text-gray-400">
                  ...
                  <a
                    href="/login"
                    className="text-[#2E8B75] font-medium hover:underline"
                  >
                    Back to Login
                  </a>
                </div>
