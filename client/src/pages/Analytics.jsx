...
const AnalyticsDashboard = () => {
  ...
  const COLORS = ["#C8E6E0", "#7DDAC1", "#38B69A", "#2E8B75", "#195C4B"];
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-[#38B69A] rounded-lg flex items-center justify-center text-white">
            {habit.icon}
          </div>
          <div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#f8f4ff] to-[#f0e5ff] flex items-center justify-center">
        ...
        >
          <motion.div
            ...
            className="w-16 h-16 border-4 border-[#38B69A] border-t-transparent rounded-full mx-auto mb-4"
          />
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.5 }}
            className="text-[#38B69A] font-semibold text-lg"
          >
  ...
  return (
    <div className="min-h-screen p-4 md:p-8 text-gray-800 bg-gradient-to-br from-[#f8f4ff] to-[#f0e5ff]">
      ...
      <div className="text-center mb-8 md:mb-12">
        ...
        >
          Track Your Progress <span className="text-[#38B69A]">✨</span>
        </motion.h1>
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          Visualize your habits, goals, and achievements in one beautiful
          dashboard <span className="text-[#38B69A]">💜</span>
        </motion.p>
      </div>
          ...
          {[
            ...
            <motion.button
              ...
              className={`flex-1 py-3 px-4 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-2 ${
                activeTab === tab.id
                  ? "bg-[#38B69A] text-white shadow-md"
      ...
      <div className="flex justify-center mb-8">
        <motion.button
          ...
          className="flex items-center gap-3 px-6 py-3 bg-[#38B69A] hover:bg-[#2E8B75] text-white rounded-xl shadow-lg hover:shadow-xl transition-all font-semibold"
        >
          <FaSync />
          Refresh Analytics
        </motion.button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                <FaChartLine className="text-[#38B69A]" />
            ...
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={analyticsData.monthlyTrends}>
                ...
                <Line
                  ...
                  stroke="#38B69A"
                  strokeWidth={3}
                  dot={{ fill: "#38B69A", strokeWidth: 2, r: 4 }}
                />
              </LineChart>
            </ResponsiveContainer>
          </motion.div>
            ...
            <div className="flex justify-between items-center mb-8">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 flex items-center gap-3">
                  <FaFlag className="text-[#38B69A]" />
                  Your Goals Progress
                </h3>
                <p className="text-gray-600 mt-2">
                  {analyticsData.overview.completedGoals} of{" "}
                  {analyticsData.overview.totalGoals} goals completed
                </p>
              </div>
              <div className="text-right">
                <div className="text-3xl font-bold text-[#38B69A]">
            ...
            {analyticsData.goalsData.length > 0 ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-gray-600 text-lg max-w-md mx-auto">
                  Start setting goals to track your progress and achieve amazing
                  things!
                </p>
              </div>
            )}
          ...
          >
            ...
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={analyticsData.habitPerformance}>
                ...
                <YAxis />
                <Tooltip />
                <Bar dataKey="monday" fill="#C8E6E0" name="Monday" />
                <Bar dataKey="tuesday" fill="#7DDAC1" name="Tuesday" />
                <Bar dataKey="wednesday" fill="#38B69A" name="Wednesday" />
                <Bar dataKey="thursday" fill="#2E8B75" name="Thursday" />
                <Bar dataKey="friday" fill="#195C4B" name="Friday" />
              </BarChart>
            </ResponsiveContainer>
          </motion.div>
        </motion.div>
            ...
            >
              ...
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={analyticsData.habitCategories}>
                  ...
                  <YAxis />
                  <Tooltip />
                  <Bar dataKey="count" fill="#38B69A" name="Total Habits" />
                  <Bar dataKey="completed" fill="#195C4B" name="Completed" />
                </BarChart>
              </ResponsiveContainer>
            </motion.div>
          </div>
      ...
      <footer className="text-center mt-12 md:mt-16 text-gray-600 text-sm">
        © 2025 Progress Tracker — Designed with{" "}
        <span className="text-[#38B69A]">💚</span> to help you grow & achieve.
      </footer>
    </div>
  );
};
