...
const HabitTracker = () => {
  ...
  const updateStats = (habitsList) => {
    ...
    const currentStreak = Math.max(
      ...habitsList.map((habit) => habit.streak),
      0
    );
  ...
  const toggleHabit = async (id) => {
    try {
      ...
      setStats((prev) => ({
        ...
        completedToday:
          prev.completedToday +
          (habits.find((h) => h.id === id).completed ? -1 : 1),
      }));
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 flex items-center justify-center">
        <div className="text-center">
          <FaSpinner className="text-4xl text-[#38B69A] animate-spin mx-auto mb-4" />
    ...
    <header className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8">
      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
        <button
          ...
          className="group bg-gradient-to-r from-[#38B69A] to-[#2E8B75] text-white px-6 py-4 rounded-2xl font-semibold flex items-center justify-center gap-3 hover:shadow-2xl hover:scale-105 transition-all duration-300 shadow-lg"
        >
...
const MainContent = () => {
  const { habits, toggleHabit, deleteHabit, setShowCreateModal, loading } =
    useHabit();

  if (loading) {
    return (
      <div className="flex justify-center items-center py-12">
        <FaSpinner className="text-2xl text-[#38B69A] animate-spin" />
      </div>
    );
  }
    ...
    <main className="mb-8">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2 text-gray-500">
          <FaCalendar className="text-[#38B69A]" />
          <span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-4">
                  <div
                    className={`w-14 h-14 bg-gradient-to-br ${habit.color} rounded-2xl flex items-center justify-center group-hover:rotate-12 transition-transform duration-300`}
                  >
        ...
        {/* Add New Habit Card */}
        <div
          className="group bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-6 border-2 border-dashed border-gray-300 hover:border-[#38B69A] hover:bg-gradient-to-br hover:from-purple-50 hover:to-pink-50 transition-all duration-500 cursor-pointer flex flex-col items-center justify-center min-h-[160px] text-center"
          onClick={() => setShowCreateModal(true)}
        >
          <div className="w-14 h-14 bg-gradient-to-br from-[#38B69A] to-[#2E8B75] rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 group-hover:rotate-12 transition-transform duration-300">
            <FaPlus className="text-white text-xl" />
          </div>
          <p className="text-gray-600 font-medium">Add New Habit</p>
          <p className="text-gray-400 text-sm mt-1">
            Click to create a new habit
          </p>
        </div>
      </div>
    </main>
        ...
        <button
          className={`flex items-center gap-2 px-6 py-3 rounded-xl font-medium transition-all duration-300 ${
            activeTab === "edit"
              ...
              : "text-gray-600 hover:text-[#38B69A] hover:bg-gray-100"
          }`}
...
const CreateHabitModal = () => {
  const { setShowCreateModal, newHabit, updateNewHabit, createHabit } =
    useHabit();
      ...
      <div className="bg-white rounded-2xl p-8 max-w-2xl w-full shadow-2xl animate-scale-in my-8">
        ...
        <div className="space-y-6 max-h-96 overflow-y-auto pr-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#38B69A] focus:border-transparent transition-all duration-300"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="3"
              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#38B69A] focus:border-transparent transition-all duration-300 resize-none"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateNewHabit("timesPerDay", parseInt(e.target.value))
              }
              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#38B69A] focus:border-transparent transition-all duration-300"
            />
          </div>
        ...
        <div className="flex gap-3 pt-8 border-t border-gray-200 mt-6">
          ...
          <button
            ...
            className="flex-1 px-6 py-4 bg-gradient-to-r from-[#38B69A] to-[#38B69A] text-white rounded-xl font-medium hover:shadow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Create Habit
          </button>
        </div>
