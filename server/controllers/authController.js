...
exports.forgotPassword = async (req, res) => {
  try {
    ...
    const resetLink = `http://localhost:5177/reset-password?token=${rawToken}&email=${encodeURIComponent(
      user.email
    )}`;
    ...
    return res.json({
      ok: true,
      message:
        "Password reset link generated successfully (check console or email)",
